<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    ...
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
        <div class="text-center mr-2 mb-2"> <a class="button inline-block bg-theme-1 text-white addPhotoBtn">Add Photo</a> </div>
    </div>
</div>
<!-- BEGIN: Datatable -->
                            ...
                            <tr>
                                ...
                                <td class="border-b w-5">
                                    <div class="flex sm:justify-center items-center">
                                        <button class="flex items-center mr-3 editPhotoModal" value="<?= $c['foto']; ?>"> <i
                                                data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit </button>
                                        <button class="flex items-center text-theme-6 deletePhotoBtn" value="<?= $c['foto']; ?>">
...
<div class="modal" id="addPhotoModal">
    <div class="modal__content">
        <div class="flex items-center px-5 py-5 sm:py-3 border-b border-gray-200">
            <h2 class="font-medium text-bPhotoe mr-auto">Add Photo</h2>
        ...
        <form class="p-5 grid grid-cols-12 gap-4 row-gap-3" id="addPhoto" enctype="multipart/form-data">
    ...
    <div class="modal" id="editPhotoModal">
        <div class="modal__content">
            <div class="flex items-center px-5 py-5 sm:py-3 border-b border-gray-200">
                <h2 class="font-medium text-bPhotoe mr-auto">Photo</h2>
            </div>
            <form class="p-5 grid grid-cols-12 gap-4 row-gap-3" id="editPhoto" enctype="multipart/form-data">
                ...
                <div class="col-span-12 sm:col-span-12">
                    ...
                    <div class="col-span-12 sm:col-span-12">
                        ...
                        <input required type="text" id="edit_title" class="input w-full border mt-2 flex-1"
                            name="edit_title" placeholder="Photo Title">
                    </div>
                </div>
                <div class="col-span-12">
                    <label>Category</label>
