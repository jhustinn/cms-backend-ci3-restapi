        ...
        <tbody>
            <?php foreach ($content as $c): ?>
                    <tr>
                        ...
                        <td class="border-b">
                            <div class="font-medium whitespace-no-wrap">
                                <?php if (strlen($c['keterangan']) > 40) {
                                    // If it is, truncate the text and append '...read more'
                                    echo substr($c['keterangan'], 10, 40) . '...';
                                } else {
    ...
    <div class="modal__content">
        ...
        <form class="p-5 grid grid-cols-12 gap-4 row-gap-3" id="addContent" enctype="multipart/form-data">
            ...
            <div class="col-span-12 sm:col-span-12">
                ...
                <textarea required data-feature="all" data-height="250" class="summernote" style="display: none;"
                    name="keterangan" placeholder="Description"></textarea>
            </div>
    ...
    <div class="modal" id="editContentModal">
        <div class="modal__content">
            ...
            <form class="p-5 grid grid-cols-12 gap-4 row-gap-3" id="editContent" enctype="multipart/form-data">
                ...
                <div class="col-span-12 sm:col-span-12">
                    <label>Description</label>
                    <textarea required id="edit_description" name="edit_description" placeholder="Description" required
                        data-feature="all" data-height="250" class="summernote" style="display: none;"></textarea>
                </div>
                <div class="px-5 py-3 text-right border-t border-gray-200 flex">
                    <button type="button" data-dismiss="modal"
